...
const message: Message[] = [
    ...
    {
        monitor: '然后呢?',
        reply: ['懂一点点Python, 主要还是前端方面比较会 HTML/CSS/JavaScript, 其他框架嘛 Vue/Electron', '人生远不止眼前的苟且, 还有诗与远方.', '喜欢动漫、沉迷Galgame、梦想去一趟日本', '然后得过且过'],
        event: ['message', 'direct_message'],
        options: [
            {
                title: '为啥取名叫凌寒初见? 🤭',
    ...
    {
        monitor: '少废话',
        reply: '![告辞](http://cdn.myrove.cn/img/botkit/leave.jpg?imageView2/0/w/200/h/66/q/75)',
        event: ['message', 'direct_message'],
        isInterrupt: true,
    },
    {
